...
public partial class WalletCoinjoinModel : ReactiveObject
{
	...
	/// <summary>Asks the device what policy it ended up with, so the settings screen can show the limits actually in force. Best effort: failing to read them must not undo an authorization that succeeded.</summary>
